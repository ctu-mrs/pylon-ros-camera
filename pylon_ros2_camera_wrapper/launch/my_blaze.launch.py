...
def _launch_nodes(context: LaunchContext):
    ...
    camera_id = _resolve_launch_value(context, 'camera_id', ros_params.get('camera_id'), 'my_blaze')
    respawn = _parse_bool(_resolve_launch_value(context, 'respawn', ros_params.get('respawn'), 'false'))
